...
using EASolution.Service;

namespace EASolution.Controllers
{
    public class PersonController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Phone,Address,City,ZipCode,State,CountryId")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Phone,Address,City,ZipCode,State,CountryId")] Person person)
        {
            if (ModelState.IsValid)
            {
